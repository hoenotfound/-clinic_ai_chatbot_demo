...
const PERSONAL_SUITABILITY_PATTERN = /am i suitable|is it safe for me|can i (?:do|have|get) (?:acupuncture|cupping|pelvic(?:\s+(?:adjustment|treatment|trt))?|posture\s+(?:adjustment|treatment)|3d\s+(?:facial|face)|facial\s+(?:adjustment|contour))|what should i take|what herbs should i take|what do i have|what condition do i have|diagnos|can i take\s+(?:this|these|the)?\s*(?:herb|herbs|formula|medicine|medication|supplement)|sesuai (?:untuk )?saya|selamat untuk saya|boleh saya (?:buat|ambil)\s+(?:akupunktur|cupping|bekam|rawatan\s+(?:pelvis|postur)|pelvic\s+(?:adjustment|treatment)|3d\s+(?:facial|muka))|ubat apa|herba apa|适合我吗|適合我嗎|我适合|我適合|我可以做针灸吗|我可以做針灸嗎|可以针灸吗|可以針灸嗎|能针灸吗|能針灸嗎|我可以拔罐吗|我可以拔罐嗎|可以拔罐吗|可以拔罐嗎|(?:我)?可以做(?:骨盆(?:调理|調理|调整|調整)?|体态调理|體態調理|3d小颜术|3d小顏術|小颜术|小顏術)吗|(?:我)?可以做(?:骨盆(?:调理|調理|调整|調整)?|体态调理|體態調理|3d小颜术|3d小顏術|小颜术|小顏術)嗎|(?:骨盆(?:调理|調理|调整|調整)?|体态调理|體態調理|3d小颜术|3d小顏術|小颜术|小顏術)适合我吗|(?:骨盆(?:调理|調理|调整|調整)?|体态调理|體態調理|3d小颜术|3d小顏術|小颜术|小顏術)適合我嗎|我应该吃什么中药|我應該吃什麼中藥|我是什么病|我是什麼病/i;
const POST_TREATMENT_PATTERN = /after (?:my )?(?:acupuncture|cupping|gua sha|tuina|treatment|pelvic(?:\s+(?:adjustment|treatment))?|posture\s+(?:adjustment|treatment)|3d\s+(?:facial|face)|facial\s+(?:adjustment|contour))|after taking (?:the )?herbs|post[- ]?treatment|selepas (?:akupunktur|rawatan|rawatan\s+pelvis|rawatan\s+postur|3d\s+muka)|lepas (?:akupunktur|rawatan|rawatan\s+pelvis|rawatan\s+postur|3d\s+muka)|针灸后|針灸後|拔罐后|拔罐後|刮痧后|刮痧後|推拿后|推拿後|骨盆(?:调理|調理|调整|調整)后|骨盆(?:调理|調理|调整|調整)後|小颜术后|小顏術後|3d小颜术后|3d小顏術後|吃了中药|吃了中藥/i;
