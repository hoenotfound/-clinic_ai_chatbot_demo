...
const MEDICATION_PATTERN = /medication|medicine|prescription|blood thinner|anticoagul|warfarin|aspirin|ubat|ubat cair darah|处方药|處方藥|药物|藥物|抗凝|薄血/i;
...
const PERSONAL_SUITABILITY_PATTERN = /am i suitable|is it safe for me|can i do acupuncture|can i do cupping|can i take|what should i take|what herbs should i take|what do i have|what condition do i have|diagnos|sesuai (?:untuk )?saya|selamat untuk saya|boleh saya buat|ubat apa|herba apa|适合我吗|適合我嗎|我适合|我適合|我可以做针灸吗|我可以做針灸嗎|我可以拔罐吗|我可以拔罐嗎|我应该吃什么中药|我應該吃什麼中藥|我是什么病|我是什麼病/i;
